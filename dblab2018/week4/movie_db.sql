...
CREATE UNIQUE INDEX `country_id_UNIQUE` ON `countries` (`country_id` ASC);
...
CREATE UNIQUE INDEX `movie_id_UNIQUE` ON `movies` (`movie_id` ASC);
...
CREATE UNIQUE INDEX `director_id_UNIQUE` ON `directors` (`director_id` ASC);
...
CREATE UNIQUE INDEX `star_id_UNIQUE` ON `stars` (`star_id` ASC);
...
INSERT INTO `movies` (`movie_id`, `title`, `ranking`, `rating`, `year`, `votes`, `duration`, `oscars`, `budget`) VALUES (21, 'test', 21, 7.7, 2009, 659102, 180, 3, 900000);
